...
const images = [
  'https://cdn.poehali.dev/projects/337dc164-289e-470a-b86f-ee41c74ec18d/files/7a59f2a7-408e-4c64-9ada-c8b7c05b61fc.jpg',
  'https://cdn.poehali.dev/projects/337dc164-289e-470a-b86f-ee41c74ec18d/files/9ca58de3-d607-48e9-abf4-c8c668bd1c4b.jpg',
  'https://cdn.poehali.dev/projects/337dc164-289e-470a-b86f-ee41c74ec18d/files/2d20cc98-e91f-40b2-8201-4c6823dbb908.jpg',
...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-stone-900">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-stone-900/95 via-stone-900/60 to-transparent" />
          ...
          <div className="flex max-w-2xl flex-col gap-10">
            ...
            >
              <p className="max-w-md text-base font-light leading-relaxed text-white/60">
                Добро пожаловать в пространство гармонии и красоты. Каждая услуга — шаг к вашему благополучию, а не просто косметическая процедура.
              </p>
            </div>
            ...
            >
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-sm text-white/50">г. Нарьян-Мар, ул. Полярная, 25А</span>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex gap-5">
                <a
                  ...
                  className="text-white/50 transition-colors hover:text-amber-300"
                  aria-label="Telegram"
                >
